...
// TODO: MAKE TIME AND DATE-PICKER MORE REUSEABLE 
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            Text(drugTypes[index],
                              style: TextStyle(
                                  color:  index == selectedIndex ? Theme.of(context).primaryColorLight : Theme.of(context).primaryColorDark,
...
// This sets the time if the reminder frequency is set to once 
  ...
  // This sets the time if the reminder frequency is set to thrice 
  ...
  // This sets the time if the reminder frequency is set to twice 
...
// This brings up the timepicker widget for once selection 
...
// This is to pop up a date picker for start date 
...
// This is to pop up a date picker for end date 
