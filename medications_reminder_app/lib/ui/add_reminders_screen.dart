...
//Instantiating a SizeConfig object to handle responsiveness
                                      ...
                                      if (difference == 0) {
                                        ...
                                        switch (widget.buttonText) {
                                          case 'Add Schedule':
                                            ...
                                            print(db.firstTime.toString()+db.secondTime.toString()+db.thirdTime.toString());
  ...
  Future<Null> selectFirstTime(BuildContext context, DB db) async {
    ...
    var selectedInMinutes = selectedTime.hour * 60 + selectedTime.minute;
    print(selectedInMinutes);
    print(nowInMinutes);
    if(selectedInMinutes == nowInMinutes){
      showSnackBar(
          context, text: "Cannot set reminder in the present time");
    }else {
