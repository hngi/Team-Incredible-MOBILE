                  ...
                  children: <Widget>[
                    ...
                    Container(
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: index == db.selectedIndex ? Theme.of(context).buttonColor : Theme.of(context).primaryColorLight,
                                  borderRadius: BorderRadius.circular(config.xMargin(context, 4))
                                ),
                                child: Center(child:
                                Text(db.drugTypes[index],
                                style: TextStyle(
                                  color:  index == db.selectedIndex ? Theme.of(context).primaryColorLight : Theme.of(context).primaryColorDark.withOpacity(.9),
                      ...
                      Row(
                        ...
                        db.selectedFreq == 'Once' ? _once(localizations, db) : db.selectedFreq == 'Twice' ? _twice(localizations, db) :
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  FlatButton(
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        Text(localizations.formatShortMonthDay(db.startDate),
                                        style: TextStyle(
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  FlatButton(
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        Text(localizations.formatShortMonthDay(db.endDate),
                                        style: TextStyle(
                                          fontSize: config.xMargin(context, 4.2)
                                        ),
                                        ),
      ...
      children: <Widget>[
        Icon(
                          ...
                          InkWell(
                            ...
                            child: Text(localizations.formatTimeOfDay(db.firstTime),
                            style: TextStyle(
                              fontSize: config.xMargin(context, 4.2)
                            ),
                            ),
      ...
      children: <Widget>[
        ...
        Icon(
                          ...
                          InkWell(
                            ...
                            child: Text(localizations.formatTimeOfDay(db.secondTime),
                            style: TextStyle(
                              fontSize: config.xMargin(context, 4.2)
                            ),
                            ),
        ...
        Icon(
                          ...
                          InkWell(
                            ...
                            child: Text(localizations.formatTimeOfDay(db.thirdTime),
                            style: TextStyle(
                              fontSize: config.xMargin(context, 4.2)
                            ),
                            ),
