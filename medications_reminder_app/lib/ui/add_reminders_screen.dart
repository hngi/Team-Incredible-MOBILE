                                ...
                                child: FlatButton(
                                  ...
                                  onPressed: () {
                                    if (nameController.text.isNotEmpty) {
                                      ...
                                      var difference = db.endDate.difference(db.startDate).inHours;
                                      print(difference);
                                      if(difference < 20){
                                        showSnackBar(context,text: "Start date should be different from end date");
                                      }else {
                                        print(db.firstTime);
                                        print(db.secondTime);
                                        print(db.thirdTime);
                                        ...
                                        switch (widget.buttonText) {
                                          ...
                                          case 'Update Schedule':
                                            ...
                                            if (db.selectedFreq == 'Twice') {
                                              times2.forEach((val) =>
                                                  scheduleNotifications(val, db,
                                                      notificationManager));
                                            } else
                                            if (db.selectedFreq == 'Thrice') {
                                              times3.forEach((val) =>
                                                  scheduleNotifications(val, db,
                                                      notificationManager));
                                            }
