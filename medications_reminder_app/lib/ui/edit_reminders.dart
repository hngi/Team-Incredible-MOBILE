...
class _EditRemindersState extends State<EditReminders> {
  ...
  String drugName;
  final _reminders = GlobalKey<FormState>();
                        ...
                        children: <Widget>[
                          ...
                          Center(
                            ...
                            child: FlatButton(
                              ...
                              onPressed: () {
                                if (_reminders.currentState.validate()) {
                                  
                                  // final now = new DateTime.now();
                                  // final firstTime = new DateTime(now.year, now.month,
                                  //     now.day, _currentTime.hour, _currentTime.minute);
                                  //     final secondTime = new DateTime(now.year, now.month,
                                  //     now.day, _currentTime2.hour, _currentTime2.minute);
                                  //     final thirdTime = new DateTime(now.year, now.month,
                                  //     now.day, _currentTime3.hour, _currentTime3.minute);
                                  final newSchedule = Schedule(
                                      ...
                                      startDate: startDate,
                                      endDate: endDate,
                                      firstTime: _currentTime,
                                      secondTime: _currentTime2,
                                      thirdTime: _currentTime3);
                                      
                                  scheduleBox.add(newSchedule);
                                  print(newSchedule.name);
