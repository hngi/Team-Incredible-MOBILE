                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          widget.schedule.firstTime != []
                              ? Text(
                                  localizations.formatTimeOfDay(
                                      db.timeFromDB(widget.schedule.firstTime)),
                                  style: TextStyle(
                          ...
                          widget.schedule.secondTime != []
                              ? Text(
                                  localizations.formatTimeOfDay(db
                                      .timeFromDB(widget.schedule.secondTime)),
                                  style: TextStyle(
                                      color: Colors.grey[400],
                                      fontSize: config.xMargin(context, 4)),
                                )
                          ...
                          widget.schedule.thirdTime != []
                              ? Text(
                                  localizations.formatTimeOfDay(
                                      db.timeFromDB(widget.schedule.thirdTime)),
                                  style: TextStyle(
                                      color: Colors.grey[400],
                                      fontSize: config.xMargin(context, 4)),
                                )
                      ...
                      SizedBox(height: config.yMargin(context, 2)),
                      Text(
                        widget.schedule.dosage < 2
                            ? widget.schedule.dosage.toString() + ' Pill'
                            : ' Pills',
                        textAlign: TextAlign.left,
                        style: TextStyle(
                          fontSize: config.xMargin(context, 5),
